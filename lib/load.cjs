...
module.exports = require('@neon-rs/load').proxy({
    platforms: {
        'win32-x64-msvc': () => require('@demo/win32-x64-msvc'),
        'darwin-x64': () => require('@demo/darwin-x64'),
        'darwin-arm64': () => require('@demo/darwin-arm64'),
        'linux-x64-gnu': () => require('@demo/linux-x64-gnu'),
        'linux-arm64-gnu': () => require('@demo/linux-arm64-gnu')
    },
